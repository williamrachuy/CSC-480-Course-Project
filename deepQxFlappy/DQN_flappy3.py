...
def mainGame(movementInfo):
    ...
    while True:
        ...
        elif (playerx < lowerPipes[0]['x'] and playery < upperPipes[0]['y'] - PIPEGAPSIZE - IMAGES['player'][0].get_height()): #"""playery > lowerPipes[0]['y'] or"""
            reward = -10
            done = False
        elif(playerx < lowerPipes[1]['x'] and playery < lowerPipes[1]['y'] - PIPEGAPSIZE - IMAGES['player'][0].get_height()): #"""playery > lowerPipes[1]['y'] or"""
            reward = -10
            done = False
        else:
            reward = 1
