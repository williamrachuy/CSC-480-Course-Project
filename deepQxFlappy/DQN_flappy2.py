...
def mainGame(movementInfo):
    ...
    if (playerx < lowerPipes[0['x']]):
        ...
        deltaX = lowerPipes[1]['x'] - playerx
        deltaY = lowerPipes[1]['y'] - playery
    ...
    while True:
        ...
        elif (playerx < lowerPipes[0]['x']):
            if(playery > lowerPipes[0]['y'] or playery < lowerPipes[0]['y'] + PIPEGAPSIZE - IMAGES['player'][0].get_height()):
                reward = -10
            else:
                reward = 1
            done = False
        elif(playerx < lowerPipes[1]['x']):
            if(playery > lowerPipes[1]['y'] or playery < lowerPipes[1]['y'] + PIPEGAPSIZE  - IMAGES['player'][0].get_height()):
                reward = -10
            else:
                reward = 1
        else:
        ...
        # TODO TODO TODO
        """elif (playery < lowerPipes[0]['y'] and playerx < lowerPipes[0]['x']):
            reawrd = -10
            done = False
        elif(playery < lowerPipes[1]['y'] and playerx < lowerPipes[1]['x']):
            reward = -10
            done = False"""
